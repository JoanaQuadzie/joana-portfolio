...
export default function about() {
    return (
        <div className="bg-zinc-800 text-amber-400 mb-10">
            <div className="text-center">
                <h2 className="text-3xl py-6 font-bold">ABOUT ME</h2>
                <p className="text-1xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis aut pariatur ut eveniet amet totam tempore</p>
            </div>
            <div className="flex grid-cols-2 ml-5 py-10">
                <div className="">
                    <h3 className="text-2xl py-6 font-bold">Get To Know Me</h3>
                    <p className="text-1xl">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Facere repellat animi exercitationem a praesentium aliquam. Dicta maxime maiores libero nesciunt dolor laborum ullam minima debitis alias, quisquam rem sint pariatur</p>
                </div>
                <div>
                    <h3 className="text-2xl gap-11 py-6 font-bold">Skills</h3>
                    ...
                    <button type="button" class="focus:outline-none text-black bg-white  focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Vercel</button>
                    <button type="button" class="focus:outline-none text-black bg-white  focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Jira</button>
