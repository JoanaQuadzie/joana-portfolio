    ...
    return (
        <div className="bg-zinc-300 text-black mb-10">
            <div className="text-center">
                ...
                <p className="text-1xl w-6/6 mx-96">As an optimistic individual with a background in administrative and sales assistant roles, I have cultivated a
                    wealth of experience in fostering reliable customer relationships, refining interpersonal communication skills,
                    and excelling in both remote and in-person work environments. My contributions have been instrumental in
                    driving the growth of the organizations I've served.
            ...
            <div>
                ...
                <div className="w-4/4 mx-96 pb-32 space-y-8" >
                    ...
                    <button type="button" class="focus:outline-none text-black bg-white  focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900 py-6">MongoDB</button>
